...
import com.viettel.mobileca.signature.utils.Constants;
...
public class SignWS {
	...
	@GET
	@Produces({ MediaType.TEXT_PLAIN })
	public String signPDF(@PathParam("phoneNumber") String phoneNumber, @PathParam("b64File") String b64File)
			throws Exception {
		...
		/* FileAction.deleteFile(filePath); */ // xoa file nhan sau khi xu ly xong
	...
	@GET
	@Produces({ MediaType.TEXT_PLAIN })
	public String signXML(@PathParam("phoneNumber") String phoneNumber, @PathParam("b64File") String b64File) throws Exception{
		/* b64File1 = FileAction.fileEncode(System.getProperty("catalina.base" )+"/wtpwebapps/MobileCA-WS/etc/config.xml");*/
		certString = (String) APQueryCertificate.onProcess(phoneNumber);
        vtCertString = "";
        CertificateFactory cf = CertificateFactory.getInstance("X.509");
        X509Certificate userCert = (X509Certificate) cf.generateCertificate(new ByteArrayInputStream(Base64.decode(certString.getBytes())));
        X509Certificate viettelCert = (X509Certificate) cf.generateCertificate(new ByteArrayInputStream(Base64.decode(vtCertString.getBytes())));
        Certificate[] chain = new Certificate[]{userCert, viettelCert};
	 ...
	 * @param phoneNumber
	 * @param b64File
	 * @param fileType dinh dang file cua office
	 * @return
	 * @throws Exception
	 */
	...
	@GET
	@Produces({ MediaType.TEXT_PLAIN })
	public String signMSOffice(@PathParam("phoneNumber") String phoneNumber, @PathParam("b64File") String b64File,@PathParam("fileType") String fileType) throws Exception{
		/* b64File1 = FileAction.fileEncode(System.getProperty("catalina.base" )+"/wtpwebapps/MobileCA-WS/etc/demo.docx");*/
		certString = (String) APQueryCertificate.onProcess(phoneNumber);
        vtCertString = "";
        CertificateFactory cf = CertificateFactory.getInstance("X.509");
        X509Certificate userCert = (X509Certificate) cf.generateCertificate(new ByteArrayInputStream(Base64.decode(certString.getBytes())));
        ...
        String filePath = FileAction.saveFile(b64File, fileType);
